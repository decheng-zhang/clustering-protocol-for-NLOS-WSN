//
// Generated file, do not edit! Created by nedtool 4.6 from src/node/communication/routing/pso_CCP/PSO_CCP_Packet.msg.
//
...
EXECUTE_ON_STARTUP(
    cEnum *e = cEnum::find("PSO_CCP_Packet_Type");
    if (!e) enums.getInstance()->add(e = new cEnum("PSO_CCP_Packet_Type"));
    e->insert(PSO_CCP_ADV_PACKET, "PSO_CCP_ADV_PACKET");
    e->insert(PSO_CCP_JOIN_PACKET, "PSO_CCP_JOIN_PACKET");
    e->insert(PSO_CCP_TDMA_PACKET, "PSO_CCP_TDMA_PACKET");
    e->insert(PSO_CCP_DATA_PACKET, "PSO_CCP_DATA_PACKET");
    e->insert(PSO_CCP_FIND_NEIGHBOURS_PACKET, "PSO_CCP_FIND_NEIGHBOURS_PACKET");
);

Register_Class(PSO_CCP_Packet);

PSO_CCP_Packet::PSO_CCP_Packet(const char *name, int kind) : ::RoutingPacket(name,kind)
{
    this->numOfPackets_var = 0;
    this->PSO_CCP_PacketKind_var = 0;
    schedule_arraysize = 0;
    this->schedule_var = 0;
}

PSO_CCP_Packet::PSO_CCP_Packet(const PSO_CCP_Packet& other) : ::RoutingPacket(other)
{
    schedule_arraysize = 0;
    this->schedule_var = 0;
    copy(other);
...
PSO_CCP_Packet::~PSO_CCP_Packet()
{
    delete [] schedule_var;
}

PSO_CCP_Packet& PSO_CCP_Packet::operator=(const PSO_CCP_Packet& other)
{
...
void PSO_CCP_Packet::copy(const PSO_CCP_Packet& other)
{
    this->info_var = other.info_var;
    this->numOfPackets_var = other.numOfPackets_var;
    this->PSO_CCP_PacketKind_var = other.PSO_CCP_PacketKind_var;
...
nodeData& PSO_CCP_Packet::getInfo()
{
    return info_var;
}

void PSO_CCP_Packet::setInfo(const nodeData& info)
{
    this->info_var = info;
}

int PSO_CCP_Packet::getNumOfPackets() const
{
    return numOfPackets_var;
}

void PSO_CCP_Packet::setNumOfPackets(int numOfPackets)
{
    this->numOfPackets_var = numOfPackets;
}

int PSO_CCP_Packet::getPSO_CCP_PacketKind() const
{
    return PSO_CCP_PacketKind_var;
}

void PSO_CCP_Packet::setPSO_CCP_PacketKind(int PSO_CCP_PacketKind)
{
    this->PSO_CCP_PacketKind_var = PSO_CCP_PacketKind;
}

void PSO_CCP_Packet::setScheduleArraySize(unsigned int size)
{
...
unsigned int PSO_CCP_Packet::getScheduleArraySize() const
{
    return schedule_arraysize;
}

int PSO_CCP_Packet::getSchedule(unsigned int k) const
{
    if (k>=schedule_arraysize) throw cRuntimeError("Array of size %d indexed by %d", schedule_arraysize, k);
    return schedule_var[k];
}

void PSO_CCP_Packet::setSchedule(unsigned int k, int schedule)
{
    if (k>=schedule_arraysize) throw cRuntimeError("Array of size %d indexed by %d", schedule_arraysize, k);
    this->schedule_var[k] = schedule;
}

class PSO_CCP_PacketDescriptor : public cClassDescriptor
{
  public:
    PSO_CCP_PacketDescriptor();
    virtual ~PSO_CCP_PacketDescriptor();
...
Register_ClassDescriptor(PSO_CCP_PacketDescriptor);

PSO_CCP_PacketDescriptor::PSO_CCP_PacketDescriptor() : cClassDescriptor("PSO_CCP_Packet", "RoutingPacket")
{
}

PSO_CCP_PacketDescriptor::~PSO_CCP_PacketDescriptor()
{
}

bool PSO_CCP_PacketDescriptor::doesSupport(cObject *obj) const
{
    return dynamic_cast<PSO_CCP_Packet *>(obj)!=NULL;
}

const char *PSO_CCP_PacketDescriptor::getProperty(const char *propertyname) const
{
    cClassDescriptor *basedesc = getBaseClassDescriptor();
    return basedesc ? basedesc->getProperty(propertyname) : NULL;
}

int PSO_CCP_PacketDescriptor::getFieldCount(void *object) const
{
    cClassDescriptor *basedesc = getBaseClassDescriptor();
    return basedesc ? 4+basedesc->getFieldCount(object) : 4;
}

unsigned int PSO_CCP_PacketDescriptor::getFieldTypeFlags(void *object, int field) const
{
    cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount(object))
...
const char *PSO_CCP_PacketDescriptor::getFieldName(void *object, int field) const
{
    cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount(object))
...
int PSO_CCP_PacketDescriptor::findField(void *object, const char *fieldName) const
{
    cClassDescriptor *basedesc = getBaseClassDescriptor();
    int base = basedesc ? basedesc->getFieldCount(object) : 0;
    if (fieldName[0]=='i' && strcmp(fieldName, "info")==0) return base+0;
    if (fieldName[0]=='n' && strcmp(fieldName, "numOfPackets")==0) return base+1;
    if (fieldName[0]=='P' && strcmp(fieldName, "PSO_CCP_PacketKind")==0) return base+2;
    if (fieldName[0]=='s' && strcmp(fieldName, "schedule")==0) return base+3;
    return basedesc ? basedesc->findField(object, fieldName) : -1;
}

const char *PSO_CCP_PacketDescriptor::getFieldTypeString(void *object, int field) const
{
    cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount(object))
...
const char *PSO_CCP_PacketDescriptor::getFieldProperty(void *object, int field, const char *propertyname) const
{
    cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount(object))
    ...
    switch (field) {
        case 2:
            if (!strcmp(propertyname,"enum")) return "PSO_CCP_Packet_Type";
            return NULL;
        default: return NULL;
    }
}

int PSO_CCP_PacketDescriptor::getArraySize(void *object, int field) const
{
    cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount(object))
    ...
    PSO_CCP_Packet *pp = (PSO_CCP_Packet *)object; (void)pp;
    switch (field) {
...
std::string PSO_CCP_PacketDescriptor::getFieldAsString(void *object, int field, int i) const
{
    cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount(object))
    ...
    switch (field) {
        ...
        case 2: return long2string(pp->getPSO_CCP_PacketKind());
        case 3: return long2string(pp->getSchedule(i));
        default: return "";
    }
}

bool PSO_CCP_PacketDescriptor::setFieldAsString(void *object, int field, int i, const char *value) const
{
    cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount(object))
    ...
    switch (field) {
        ...
        case 2: pp->setPSO_CCP_PacketKind(string2long(value)); return true;
        case 3: pp->setSchedule(i,string2long(value)); return true;
        default: return false;
    }
}

const char *PSO_CCP_PacketDescriptor::getFieldStructName(void *object, int field) const
{
    cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount(object))
...
void *PSO_CCP_PacketDescriptor::getFieldStructPointer(void *object, int field, int i) const
{
    cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount(object))
