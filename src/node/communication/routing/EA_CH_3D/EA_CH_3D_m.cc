...
EXECUTE_ON_STARTUP(
    cEnum *e = cEnum::find("EA_CH_3D_Packet_Type");
    if (!e) enums.getInstance()->add(e = new cEnum("EA_CH_3D_Packet_Type"));
    e->insert(EA_CH_3D_ADV_PACKET, "EA_CH_3D_ADV_PACKET");
    e->insert(EA_CH_3D_JOIN_PACKET, "EA_CH_3D_JOIN_PACKET");
    e->insert(EA_CH_3D_TDMA_PACKET, "EA_CH_3D_TDMA_PACKET");
    e->insert(EA_CH_3D_DATA_PACKET, "EA_CH_3D_DATA_PACKET");
    e->insert(EA_CH_3D_FIND_NEIGHBOURS_PACKET, "EA_CH_3D_FIND_NEIGHBOURS_PACKET");
);

Register_Class(EA_CH_3D_Packet);

EA_CH_3D_Packet::EA_CH_3D_Packet(const char *name, int kind) : ::RoutingPacket(name,kind)
{
    this->numOfPackets_var = 0;
    this->EA_CH_3D_PacketKind_var = 0;
    schedule_arraysize = 0;
    this->schedule_var = 0;
}

EA_CH_3D_Packet::EA_CH_3D_Packet(const EA_CH_3D_Packet& other) : ::RoutingPacket(other)
{
    schedule_arraysize = 0;
    this->schedule_var = 0;
    copy(other);
...
EA_CH_3D_Packet::~EA_CH_3D_Packet()
{
    delete [] schedule_var;
}

EA_CH_3D_Packet& EA_CH_3D_Packet::operator=(const EA_CH_3D_Packet& other)
{
...
void EA_CH_3D_Packet::copy(const EA_CH_3D_Packet& other)
{
    this->info_var = other.info_var;
    this->numOfPackets_var = other.numOfPackets_var;
    this->EA_CH_3D_PacketKind_var = other.EA_CH_3D_PacketKind_var;
...
nodeData& EA_CH_3D_Packet::getInfo()
{
    return info_var;
}

void EA_CH_3D_Packet::setInfo(const nodeData& info)
{
    this->info_var = info;
}

int EA_CH_3D_Packet::getNumOfPackets() const
{
    return numOfPackets_var;
}

void EA_CH_3D_Packet::setNumOfPackets(int numOfPackets)
{
    this->numOfPackets_var = numOfPackets;
}

int EA_CH_3D_Packet::getEA_CH_3D_PacketKind() const
{
    return EA_CH_3D_PacketKind_var;
}

void EA_CH_3D_Packet::setEA_CH_3D_PacketKind(int EA_CH_3D_PacketKind)
{
    this->EA_CH_3D_PacketKind_var = EA_CH_3D_PacketKind;
}

void EA_CH_3D_Packet::setScheduleArraySize(unsigned int size)
{
...
unsigned int EA_CH_3D_Packet::getScheduleArraySize() const
{
    return schedule_arraysize;
}

int EA_CH_3D_Packet::getSchedule(unsigned int k) const
{
    if (k>=schedule_arraysize) throw cRuntimeError("Array of size %d indexed by %d", schedule_arraysize, k);
    return schedule_var[k];
}

void EA_CH_3D_Packet::setSchedule(unsigned int k, int schedule)
{
    if (k>=schedule_arraysize) throw cRuntimeError("Array of size %d indexed by %d", schedule_arraysize, k);
    this->schedule_var[k] = schedule;
}

class EA_CH_3D_PacketDescriptor : public cClassDescriptor
{
  public:
    EA_CH_3D_PacketDescriptor();
    virtual ~EA_CH_3D_PacketDescriptor();
...
Register_ClassDescriptor(EA_CH_3D_PacketDescriptor);

EA_CH_3D_PacketDescriptor::EA_CH_3D_PacketDescriptor() : cClassDescriptor("EA_CH_3D_Packet", "RoutingPacket")
{
}

EA_CH_3D_PacketDescriptor::~EA_CH_3D_PacketDescriptor()
{
}

bool EA_CH_3D_PacketDescriptor::doesSupport(cObject *obj) const
{
    return dynamic_cast<EA_CH_3D_Packet *>(obj)!=NULL;
}

const char *EA_CH_3D_PacketDescriptor::getProperty(const char *propertyname) const
{
    cClassDescriptor *basedesc = getBaseClassDescriptor();
    return basedesc ? basedesc->getProperty(propertyname) : NULL;
}

int EA_CH_3D_PacketDescriptor::getFieldCount(void *object) const
{
    cClassDescriptor *basedesc = getBaseClassDescriptor();
    return basedesc ? 4+basedesc->getFieldCount(object) : 4;
}

unsigned int EA_CH_3D_PacketDescriptor::getFieldTypeFlags(void *object, int field) const
{
    cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount(object))
...
const char *EA_CH_3D_PacketDescriptor::getFieldName(void *object, int field) const
{
    cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount(object))
...
int EA_CH_3D_PacketDescriptor::findField(void *object, const char *fieldName) const
{
    cClassDescriptor *basedesc = getBaseClassDescriptor();
    int base = basedesc ? basedesc->getFieldCount(object) : 0;
    if (fieldName[0]=='i' && strcmp(fieldName, "info")==0) return base+0;
    if (fieldName[0]=='n' && strcmp(fieldName, "numOfPackets")==0) return base+1;
    if (fieldName[0]=='E' && strcmp(fieldName, "EA_CH_3D_PacketKind")==0) return base+2;
    if (fieldName[0]=='s' && strcmp(fieldName, "schedule")==0) return base+3;
    return basedesc ? basedesc->findField(object, fieldName) : -1;
}

const char *EA_CH_3D_PacketDescriptor::getFieldTypeString(void *object, int field) const
{
    cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount(object))
...
const char *EA_CH_3D_PacketDescriptor::getFieldProperty(void *object, int field, const char *propertyname) const
{
    cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount(object))
    ...
    switch (field) {
        case 2:
            if (!strcmp(propertyname,"enum")) return "EA_CH_3D_Packet_Type";
            return NULL;
        default: return NULL;
    }
}

int EA_CH_3D_PacketDescriptor::getArraySize(void *object, int field) const
{
    cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount(object))
    ...
    EA_CH_3D_Packet *pp = (EA_CH_3D_Packet *)object; (void)pp;
    switch (field) {
...
std::string EA_CH_3D_PacketDescriptor::getFieldAsString(void *object, int field, int i) const
{
    cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount(object))
    ...
    switch (field) {
        ...
        case 2: return long2string(pp->getEA_CH_3D_PacketKind());
        case 3: return long2string(pp->getSchedule(i));
        default: return "";
    }
}

bool EA_CH_3D_PacketDescriptor::setFieldAsString(void *object, int field, int i, const char *value) const
{
    cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount(object))
    ...
    switch (field) {
        ...
        case 2: pp->setEA_CH_3D_PacketKind(string2long(value)); return true;
        case 3: pp->setSchedule(i,string2long(value)); return true;
        default: return false;
    }
}

const char *EA_CH_3D_PacketDescriptor::getFieldStructName(void *object, int field) const
{
    cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount(object))
...
void *EA_CH_3D_PacketDescriptor::getFieldStructPointer(void *object, int field, int i) const
{
    cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount(object))
