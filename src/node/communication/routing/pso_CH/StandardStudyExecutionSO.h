...
public:
  StandardStudyExecutionSO(vector<vector<double> > adjacencyMatrix);
  Algorithm * algorithmSettings(string problemName, int algorithmId, int experimentIndividualId);
