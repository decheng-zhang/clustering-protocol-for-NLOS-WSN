 ...
 * @param problem
 */
RealSolutionType::RealSolutionType(Problem *problem): SolutionType(problem) 
{ }
...
{
  /*MOPSOProblem* p = (MOPSOProblem*) problem_;
  vector<double> c(problem_->getNumberOfVariables());
  c = p->getInitialSolution();*/
  ...
  {
    //variables[i] = new Real(c[i],problem_->getLowerLimit(i),problem_->getUpperLimit(i));
