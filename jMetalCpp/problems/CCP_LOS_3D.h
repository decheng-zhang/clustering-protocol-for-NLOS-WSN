#ifndef _CCP_LOS_3D_H_
#define _CCP_LOS_3D_H_
...
class CCP_LOS_3D : public Problem
{
	int networkSize;
	double numOfCubes;
	...
	CCP_LOS_3D(vector< vector<double>> coverageM, vector< vector<double>> overlappingM, vector< vector<double>> adjacencyM, vector<SensorInfo> sensors);
