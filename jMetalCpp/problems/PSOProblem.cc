...
using namespace std;
	...
	PSOProblem :: PSOProblem(int networkSize_)
	{

	}
	PSOProblem :: PSOProblem(vector< vector<double>> adjacencyM) 
	{
		//myfile.open("PSO_CH");
	...
	void PSOProblem :: clusterTheNetwork(vector<int> candidates)
	{
		network.clear();
	...
	string PSOProblem :: returnConfiguration(vector<int> candidates)
	{
	...
	double PSOProblem :: dijkstra(vector<int> candidates)
        {
           double dCost = 0;
	   Dijkstra G;
	...
	void PSOProblem :: printNetwork()
	{

	}

	double PSOProblem :: calculateEnergyRatio(vector<int> candidates)
	{
	...
	double PSOProblem :: getCompatness(vector<int> candidates)
	{
		double maxRSSI = -100;
	...
	double PSOProblem :: calculateNonclusteredRatio()
	{
	...
	void PSOProblem :: evaluate(Solution *solution) 
	{
	     double fitness;
